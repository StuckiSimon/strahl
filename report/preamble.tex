...
\hypersetup{%
  pdftitle={Physically-based Path Tracer using WebGPU and OpenPBR},
...
\lstdefinelanguage{wgsl}{
  morekeywords={void, attribute, struct, fn},
  morecomment=[s]{/*}{*/},
  morecomment=[l]//,
  keywords=[2]{vec2f, vec3f, vec4f, mat4x4, f32, i32, u32, vec3<u32>},
}
\lstdefinestyle{wgsl} {%
  % General design
  basicstyle={\footnotesize\ttfamily},
  ...
  ndkeywordstyle=\color{editorGreen},
  keywordstyle=[2]\color{rred},
  stringstyle=\color{editorOcher}\ttfamily,
