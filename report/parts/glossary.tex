...
\newglossaryentry{SIMD}{
  name={SIMD},
  description={\e{Single Instruction, Multiple Data}, a type of parallel processing of data points with a single instruction as defined by Flynn \cite{flynnTaxonomy}.}
}

\newglossaryentry{SIMT}{
  name={SIMT},
  description={\e{Single Instruction, Multiple Threads}, an extension to \gls{SIMD} which is frequently used on modern \glspl{GPU}.}
}
...
\newglossaryentry{OIDN}{
  name={OIDN},
  description={\e{Open Image Denoise}, an open-source library for denoising images \cite{openImageDenoise}.}
}
