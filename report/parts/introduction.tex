...
WebGPU is a new web standard that provides a robust \fGls{API}{\e{Application Programming Interface}} for leveraging the power of \gls{GPU}s across different platforms. It's designed to be more efficient and flexible than its predecessor, WebGL. This makes it ideal to be used for real-time ray tracing in the browser.
