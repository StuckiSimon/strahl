...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.3\textwidth}
    ...
    \caption{Rendering without any tone mapping applied.}
    \label{fig:tone-mapping-none}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.3\textwidth}
    \includegraphics[width=\textwidth]{resources/tonemapping-khronos-pbr-neutraltone.png}
    \caption{Rendering using Khronos PBR Neutral Tone Mapper.}
    \label{fig:tone-mapping-applied}
  \end{subfigure}
  \hspace*{2cm}
  \caption{Comparison of tone mapping with slight changes in luminance of specular reflection.}
