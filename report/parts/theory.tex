...
In order to visualize 3d scenes using a computer, different rendering approaches have been deceloped. Two of the most common approaches are rasterization and ray tracing and will be described in more detail in the following sections.
