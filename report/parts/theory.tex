...
This section highlights some basics about the mathematics involved in computer graphics and establishes a common understanding of concepts and notations referenced in the following sections. The section covers topics such as notation of vectors, matrices, and integrals.
...
An integral is used to determine the area under a curve. The integral of a function $f(x)$ over an interval $[a, b]$ is defined as:
