...
This section provides an overview of the theoretical background required to develop a path tracer. It covers the basic concepts as well as details of the underlying algorithms and data structures. Additionally, details about the involved technology as well as a historic overview are provided.
