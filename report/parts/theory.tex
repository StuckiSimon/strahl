...
Due to computational complexity, ray tracing techniques have been limited to offline rendering for a long time. Early ray tracers such as \gls{BMRT} were developed focusing on leveraging \gls{CPU} for computations. Leveraging specialized processing units has been a focus of research and has enabled real-time ray tracing in recent years.
