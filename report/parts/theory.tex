...
Since its introduction, WebGL has been extended with new features. WebGL 2.0, which is based on OpenGL ES 3.0, was released in 2017. Of the major browsers, Safari was the last to support it out of the box in 2021. Since WebGL 2.0 no new major versions have been released but new features have been added. This makes it evident that while WebGL is to remain a viable choice for rendering 3D graphics in the browser for the forseeable future, it is likely to be superseded by WebGPU in the long term.
