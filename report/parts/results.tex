...
For \gls{RNG}, the path tracer uses \gls{PCG} in combination with Xorshift, specifically the PCG-RXS-M-XS variant as described by O’Neill \cite{o2014pcg} and Xorshift as described by Marsaglia \cite{marsaglia2003xorshift}. See \coderef{RNG} for implementation.
